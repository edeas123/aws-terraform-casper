...
class TestEC2Service(TestCase):
    ...
    def test_get_cloud_resources_aws_alb(self):
        ...
        ec2 = EC2Service()
        test_group = "aws_alb"
        resources = ec2.get_cloud_resources(
            group=test_group
        )
    ...
    def test_get_cloud_resources_aws_security_group(self):
        ...
        self.assertEqual(
            count + 2,
            len(resources.keys()),
            "Created sg plus the two default sgs"
        )
        self.assertIn(
            sg[0]['GroupId'], set(resources.keys())
        )
    ...
    def test_get_cloud_resources_aws_instance(self):
        ...
        self.assertEqual(
            ...
            resources[instances[0]['InstanceId']]['ImageId']
        )
